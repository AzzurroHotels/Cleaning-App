const PROPERTY_KEY = 'pyrmont';
const CHECKLIST_KEY = 'pyrmont-cleaners-checklist-v1';
const ADDITIONAL_KEY = 'pyrmont-cleaners-additional-v1';
const RECEPTION_NOTES_KEY = 'pyrmont-reception-notes-v1';
const CLEANER_NOTES_KEY = 'pyrmont-cleaner-notes-v1';
const COMPLETED_TIMES_KEY = `${CHECKLIST_KEY}-completed-times`;

const checklistData = {
  ensuite: [
    { id: 'ensuite-room-1', title: 'Room 1', meta: 'Ground floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-3', title: 'Room 3', meta: '1st floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-4', title: 'Room 4', meta: '1st floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-6', title: 'Room 6', meta: '2nd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-7', title: 'Room 7', meta: '2nd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-9', title: 'Room 9', meta: '2nd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-10', title: 'Room 10', meta: '2nd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-11', title: 'Room 11', meta: '3rd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-12', title: 'Room 12', meta: '3rd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-13', title: 'Room 13', meta: '3rd floor · Private bathroom', bedCount: 2 },
    { id: 'ensuite-room-14', title: 'Room 14', meta: '3rd floor · Private bathroom', bedCount: 2 }
  ],
  'shared-rooms': [
    { id: 'shared-room-2', title: 'Room 2', meta: 'Ground floor', bedCount: 2 },
    { id: 'shared-room-5', title: 'Room 5', meta: '1st floor', bedCount: 2 },
    { id: 'shared-room-8', title: 'Room 8', meta: '2nd floor', bedCount: 2 }
  ],
  bathrooms: [
    { group: '1st Floor', id: 'bath-shared-1', title: 'Shared Bathroom', meta: '3 showers and 2 toilets · Beside Room 5 · 1st floor' }
  ],
  'common-areas': [
    { id: 'area-reception', title: 'Reception', meta: 'Common area' },
    { id: 'area-hallway-ground', title: 'Hallways — Ground Floor', meta: 'Common area' },
    { id: 'area-hallway-1', title: 'Hallways — Level 1', meta: 'Common area' },
    { id: 'area-hallway-2', title: 'Hallways — Level 2', meta: 'Common area' },
    { id: 'area-hallway-3', title: 'Hallways — Level 3', meta: 'Common area' },
...
function buildFullChecklistText() {
  ...
  const lines = [`*Pyrmont – Cleaning Checklist*`, `Date: ${date}`, ''];
