const PROPERTY_KEY = 'allen-darling-harbour';
const CHECKLIST_KEY = 'allen-cleaners-checklist-v1';
const ADDITIONAL_KEY = 'allen-cleaners-additional-v1';
const RECEPTION_NOTES_KEY = 'allen-reception-notes-v1';
const CLEANER_NOTES_KEY = 'allen-cleaner-notes-v2';
const COMPLETED_TIMES_KEY = `${CHECKLIST_KEY}-completed-times`;

const checklistData = {
  ensuite: [
    { id: 'ensuite-room-1', title: 'Room 1', meta: 'Ground floor · Private bathroom', bedCount: 6 },
    { id: 'ensuite-room-2', title: 'Room 2', meta: 'Ground floor · Private bathroom', bedCount: 4 },
    { id: 'ensuite-room-3', title: 'Room 3', meta: 'Ground floor · Private bathroom', bedCount: 8 },
    { id: 'ensuite-room-6', title: 'Room 6', meta: 'Outside, 1st floor · Private bathroom', bedCount: 14 },
    { id: 'ensuite-room-15', title: 'Room 15', meta: '1st floor · Private bathroom', bedCount: 6 },
    { id: 'ensuite-room-19', title: 'Room 19', meta: 'Outside, 2nd floor · Private bathroom', bedCount: 14 },
    { id: 'ensuite-room-28', title: 'Room 28', meta: '2nd floor · Private bathroom', bedCount: 6 }
  ],
  'shared-rooms': [
    { id: 'shared-room-4', title: 'Room 4', meta: 'Outside, 1st floor', bedCount: 6 },
    { id: 'shared-room-5', title: 'Room 5', meta: 'Outside, 1st floor', bedCount: 6 },
    { id: 'shared-room-7', title: 'Room 7', meta: '1st floor', bedCount: 6 },
    { id: 'shared-room-8', title: 'Room 8', meta: '1st floor', bedCount: 4 },
    { id: 'shared-room-9', title: 'Room 9', meta: '1st floor', bedCount: 4 },
    { id: 'shared-room-10', title: 'Room 10', meta: '1st floor', bedCount: 4 },
    { id: 'shared-room-11', title: 'Room 11', meta: '1st floor', bedCount: 4 },
    { id: 'shared-room-12', title: 'Room 12', meta: '1st floor', bedCount: 4 },
    { id: 'shared-room-13', title: 'Room 13', meta: '1st floor', bedCount: 6 },
    { id: 'shared-room-14', title: 'Room 14', meta: '1st floor', bedCount: 6 },
    { id: 'shared-room-16', title: 'Room 16', meta: '1st floor', bedCount: 6 },
    { id: 'shared-room-17', title: 'Room 17', meta: 'Outside, 2nd floor', bedCount: 6 },
    { id: 'shared-room-18', title: 'Room 18', meta: 'Outside, 2nd floor', bedCount: 6 },
    { id: 'shared-room-21', title: 'Room 21', meta: '2nd floor', bedCount: 8 },
    { id: 'shared-room-22', title: 'Room 22', meta: '2nd floor', bedCount: 4 },
    { id: 'shared-room-23', title: 'Room 23', meta: '2nd floor', bedCount: 6 },
    { id: 'shared-room-24', title: 'Room 24', meta: '2nd floor', bedCount: 8 },
    { id: 'shared-room-25', title: 'Room 25', meta: '2nd floor', bedCount: 6 },
    { id: 'shared-room-26', title: 'Room 26', meta: '2nd floor', bedCount: 6 },
    { id: 'shared-room-27', title: 'Room 27', meta: '2nd floor', bedCount: 6 },
    { id: 'shared-room-20', title: 'Room 20', meta: '2nd floor', bedCount: 6 }
  ],
  bathrooms: [
    { group: 'Ground Floor', id: 'bath-toilet-1', title: 'Toilet 1', meta: 'Next to Room 2' },
    { group: 'Ground Floor', id: 'bath-toilet-2', title: 'Toilet 2', meta: 'In front of Room 3' },
    { group: 'Level 1', id: 'bath-toilet-3', title: 'Toilet 3', meta: 'Next to Room 5' },
    { group: 'Level 1', id: 'bath-shower-4', title: 'Shower 4', meta: 'Next to Room 5' },
    { group: 'Level 1', id: 'bath-bathroom-5', title: 'Bathroom 5', meta: 'Shower and toilet · In front of Room 14' },
    { group: 'Level 1', id: 'bath-bathroom-6', title: 'Bathroom 6', meta: 'Shower and toilet · In front of Room 14' },
    { group: 'Level 1', id: 'bath-toilet-7', title: 'Toilet 7', meta: 'In front of Room 14' },
    { group: 'Level 1', id: 'bath-bathroom-8', title: 'Bathroom 8', meta: 'Shower and toilet · In front of Room 9' },
    { group: 'Level 1', id: 'bath-toilet-9', title: 'Toilet 9', meta: 'Next to Room 16' },
    { group: 'Level 2', id: 'bath-toilet-11', title: 'Toilet 11', meta: 'Next to Room 18' },
    { group: 'Level 2', id: 'bath-shower-12', title: 'Shower 12', meta: 'Next to Room 19' },
    { group: 'Level 2', id: 'bath-bathroom-13', title: 'Bathroom 13', meta: 'Shower and toilet · In front of Room 27' },
    { group: 'Level 2', id: 'bath-bathroom-14', title: 'Bathroom 14', meta: 'Shower and toilet · In front of Room 27' },
    { group: 'Level 2', id: 'bath-toilet-15', title: 'Toilet 15', meta: 'In front of Room 26' },
    { group: 'Level 2', id: 'bath-bathroom-16', title: 'Bathroom 16', meta: 'Shower and toilet · In front of Room 23' },
    { group: 'Level 2', id: 'bath-toilet-17', title: 'Toilet 17', meta: 'Next to Room 20' },
    { group: 'Level 2', id: 'bath-shower-18', title: 'Shower 18', meta: 'Next to Room 28' }
  ],
  'late-shift': [
    { group: '2:30 PM–3:00 PM', id: 'late-shift-01', title: 'Touch up the kitchen.', meta: '2:30 PM–3:00 PM', taskOnly: true },
    { group: '2:30 PM–3:00 PM', id: 'late-shift-02', title: 'Clean the kitchen bench, sink, and floor.', meta: '2:30 PM–3:00 PM', taskOnly: true },
    { group: '2:30 PM–3:00 PM', id: 'late-shift-03', title: 'Load linens and sheets into the washing machines.', meta: '2:30 PM–3:00 PM', taskOnly: true },
    { group: '2:30 PM–3:00 PM', id: 'late-shift-04', title: 'Wash a minimum of 30 sheets.', meta: '2:30 PM–3:00 PM', taskOnly: true },
    { group: '2:30 PM–3:00 PM', id: 'late-shift-05', title: 'Check the laundry every 45 minutes.', meta: '2:30 PM–3:00 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-06', title: 'Clean the courtyard.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-07', title: 'Clean the first-floor laundry.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-08', title: 'Clean the second-floor laundry.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-09', title: 'Update the laundry stock list immediately.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-10', title: 'Check the guest laundry area.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-11', title: 'Remove rubbish from the laundry area.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:00 PM–3:30 PM', id: 'late-shift-12', title: 'Report any machine problems immediately.', meta: '3:00 PM–3:30 PM', taskOnly: true },
    { group: '3:30 PM–4:45 PM', id: 'late-shift-13', title: 'Touch up the first-floor shared bathrooms.', meta: '3:30 PM–4:45 PM', taskOnly: true },
    { group: '3:30 PM–4:45 PM', id: 'late-shift-14', title: 'Vacuum the first floor.', meta: '3:30 PM–4:45 PM', taskOnly: true },
    { group: '3:30 PM–4:45 PM', id: 'late-shift-15', title: 'Refill bathroom supplies and remove rubbish.', meta: '3:30 PM–4:45 PM', taskOnly: true },
    { group: '4:45 PM–5:00 PM', id: 'late-shift-16', title: 'Touch up the second-floor shared bathrooms.', meta: '4:45 PM–5:00 PM', taskOnly: true },
    { group: '4:45 PM–5:00 PM', id: 'late-shift-17', title: 'Vacuum the second floor.', meta: '4:45 PM–5:00 PM', taskOnly: true },
    { group: '5:00 PM–5:30 PM', id: 'late-shift-18', title: 'Touch up ensuite bathrooms in Rooms 1, 2, 3, 6, 15, 19, and 28.', meta: '5:00 PM–5:30 PM', taskOnly: true },
    { group: '5:00 PM–5:30 PM', id: 'late-shift-19', title: 'Check stickers, markers, containers, and guest supplies.', meta: '5:00 PM–5:30 PM', taskOnly: true },
    { group: '5:00 PM–5:30 PM', id: 'late-shift-20', title: 'Report low-stock items immediately.', meta: '5:00 PM–5:30 PM', taskOnly: true },
    { group: '5:00 PM–5:30 PM', id: 'late-shift-21', title: 'Assist with guest or reception requests.', meta: '5:00 PM–5:30 PM', taskOnly: true },
    { group: '5:00 PM–5:30 PM', id: 'late-shift-22', title: 'Endorse unfinished tasks to reception for the night cleaner.', meta: '5:00 PM–5:30 PM', taskOnly: true }
  ],
  'common-areas': [
    ...
    { id: 'area-laundry', title: 'Laundry Room', meta: 'Ground floor and 1st floor machines' },
    { id: 'area-courtyard', title: 'Courtyard', meta: 'Common area' },
...
let cleanerNotes = loadJson(CLEANER_NOTES_KEY, loadJson('allen-cleaners-notes-v1', {}));
...
function getSectionDefinitions() {
  return [
    ...
    ['Afternoon Shift', checklistData['late-shift']],
...
function buildFullChecklistText() {
  ...
  const lines = [`*Allen (Darling Harbour) – Cleaning Checklist*`, `Date: ${date}`, ''];
